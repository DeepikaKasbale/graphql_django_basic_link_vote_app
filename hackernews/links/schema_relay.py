...
# define filterset using given fileds
...
class LinkNode(DjangoObjectType):
    class Meta:
        model = Link
        # implements an interface with an unique ID
...
class RelayQuery(graphene.ObjectType):
    # Uses the LinkNode with the relay_link
    relay_link = graphene.relay.Node.Field(LinkNode)
    # Defines the relay_links field as a Connection
